...
public class TreeMapDemo {
	...
	public static void main(String[] args) {
		...
		students.put(new Student("Harshita", 67), "TY");
		students.put(new Student("Sheetal", 72), "FY");
		students.put(new Student("Pallavi", 71), "SY");
		students.put(new Student("Anisha", 87), "BE");
		System.out.println(students);

		//Sort using Comparator object with Lambda Expression 
		Comparator<Student> comp = (s1,s2) -> (int) (s1.getMarks() - s2.getMarks());

		TreeMap<Student, String> t = new TreeMap<>(comp);
		t.put(new Student("Harshita", 67), "TY");
		t.put(new Student("Sheetal", 72), "FY");
		t.put(new Student("Pallavi", 71), "SY");
		t.put(new Student("Anisha", 87), "BE");
